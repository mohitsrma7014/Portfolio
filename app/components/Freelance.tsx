...
const testimonials = [
  {
    ...
    content:
      "Mohit delivered an exceptional machine learning solution that significantly improved our predictive capabilities. His expertise and professionalism made the entire process smooth and effective.",
  },
  {
    name: "Jane Smith",
    company: "Data Driven Co.",
    content:
      "Working with Mohit on our data analysis project was a game-changer. His insights helped us uncover hidden trends in our data, leading to a 20% increase in operational efficiency.",
  },
  {
    name: "Alex Johnson",
    company: "AI Solutions Ltd.",
    content:
      "Mohit's expertise in developing AI-powered web applications helped us create a unique product that set us apart from our competitors. His ability to translate complex AI concepts into practical solutions is remarkable.",
  },
]
