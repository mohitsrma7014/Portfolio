      ...
      <div className="flex flex-col lg:flex-row items-center justify-between gap-12 mb-16">
        ...
        >
          ...
          <div className="space-y-4 text-gray-300">
            <p>
              With over a year of experience as a Developer and Data Analyst at SSB Pvt. Ltd., I specialize in data
            ...
            <p>
              I have a strong foundation in machine learning, data analytics, and software development, with a keen
      ...
      >
        ...
        <div className="flex flex-col md:flex-row justify-between items-center md:items-start space-y-8 md:space-y-0 md:space-x-8">
          <div className="flex-1">
            <FaBookOpen className="text-4xl mb-4 text-blue-500 mx-auto" />
            <h4 className="text-xl font-semibold mb-2 text-center">Academic Excellence</h4>
            <ul className="list-disc list-inside text-gray-300">
              <li>Top 5% in B.Tech Mechanical Engineering</li>
              <li>Specialized coursework in AI and Data Science</li>
              <li>Multiple academic projects combining ME and DS</li>
            </ul>
          </div>
          <div className="flex-1">
            <FaLaptopCode className="text-4xl mb-4 text-blue-500 mx-auto" />
            <h4 className="text-xl font-semibold mb-2 text-center">Professional Growth</h4>
            <ul className="list-disc list-inside text-gray-300">
              <li>Internship at NBC Jaipur: Data Analytics</li>
              <li>Research Intern at Auring Technologies: AI Applications</li>
              <li>Freelance projects in ML model development</li>
            </ul>
          </div>
          <div className="flex-1">
            <FaProjectDiagram className="text-4xl mb-4 text-blue-500 mx-auto" />
            <h4 className="text-xl font-semibold mb-2 text-center">Key Projects</h4>
            <ul className="list-disc list-inside text-gray-300">
              <li>Predictive maintenance system for industrial equipment</li>
              <li>NLP-based customer feedback analysis tool</li>
              <li>Energy consumption optimization using ML</li>
            </ul>
          </div>
        </div>
      </motion.div>
