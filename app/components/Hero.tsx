    ...
    <div className="min-h-screen flex flex-col justify-center items-center relative overflow-hidden py-20 px-4">
      ...
      <div className="z-10 text-center max-w-4xl mx-auto">
        ...
        >
          <Link href="#contact">
            <motion.span
              className="px-8 py-3 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full text-lg font-semibold shadow-lg cursor-pointer inline-block"
          ...
          <Link href="#projects">
            <motion.span
              className="px-8 py-3 bg-transparent border-2 border-purple-500 rounded-full text-lg font-semibold cursor-pointer inline-block"
        ...
        >
          ...
          <motion.span
            href="https://github.com/mohitsrma"
            target="_blank"
            rel="noopener noreferrer"
          ...
          <motion.span
            href="https://twitter.com/mohitsrma"
            target="_blank"
            rel="noopener noreferrer"
